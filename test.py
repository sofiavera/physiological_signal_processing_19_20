def read_test(axis,part_body): 
    pwd = os.getcwd()
    path = '/kaggle/input/psp-urjc-challenge-1920/Data/Test'
    ...
    for s in subjects_s:
        info = np.loadtxt("/kaggle/input/psp-urjc-challenge-1920/Data/Test/" + str(subjects_s[s-1]) + "/" + str(part_body) +".txt")[:,i]
        data.append(info)
